...
if __name__ == "__main__":
    ...
    dataType = "train_traffic"

    # Annotations file
    annDir = "Annotations/02_coco_traffic"
    ...
    if len(cats) == 80:
        ...
        if cats[80]['name'] != 'traffic_light_red' or \
            ...
            raise Exception(
                "Error: Categories mismatched. Check categories to make sure the 92nd category id is traffic_light_red")
    ...
    print(
        "The available commands are as follows: (save), (q) quit, (z) back, (tag) tag image, () skip, (1)(r) label red, (2)(g) label green, (3)(n) label na, (0)(-) label back to traffic light")
    ...
    while annId_i < len(annIds):
        ...
        if ann['category_id'] in cat_show:
            ...
            image_bboxed = cv.rectangle(image, (box[0] - offset, box[1] - offset), (box[2] + offset, box[3] + offset),
                                        (252, 3, 219), 2)

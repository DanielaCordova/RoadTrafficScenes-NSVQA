...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input_json", default= 'F:/Github/COCO NSVQA/annotations/instances_train2014.json', dest="input_json",
                        help="path to a json file in coco format")
    parser.add_argument("-o", "--output_json", default= 'F:/Github/COCO NSVQA/annotations/filtered.json', dest="output_json",
                        help="path to save the output json")
    parser.add_argument("-c", "--categories", nargs='+', default= 'bicycle car motorcycle bus truck "traffic light" "stop sign" "parking meter"', dest="categories",

...
with open("F:/Github/nesy-asp-vqa-pipeline/data/CLEVR_v1.0/questions/CLEVR_val_questions.json", "r") as fp:
    questions = json.load(fp)["questions"]

random.seed(seed)
sample = random.sample(questions, n)

with open(f"F:/Github/nesy-asp-vqa-pipeline/data/CLEVR_v1.0/questions/CLEVR_val_sample_{n}.json", "w") as fp:
    json.dump(sample, fp)
